...
class Convert
{
    ...
    public function convertToJpeg(\Imagick $imagick)
    {
    ...
    public function convertToWebp(\Imagick $imagick)
    {
    ...
    public function convertToPng(\Imagick $imagick)
    {
    ...
    public function convertToGif(\Imagick $imagick)
    {
    ...
    public function convertToBmp(\Imagick $imagick)
    {
