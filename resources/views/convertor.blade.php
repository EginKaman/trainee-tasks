                                ...
                                <div class="row pt-3">
                                    <div class="col-12">
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                            @foreach($testData['negative'] as $key => $test)
                                                <tr>
                                                    <td>
                                                        @if(isset($testData['positive'][$key]))
                                                            <a href="{{ $testData['positive'][$key]['url'] }}"
                                                               target="_blank" download="">
                                                                {{ $testData['positive'][$key]['name'] }}
                                                            </a>
                                                            <span>({{ $testData['positive'][$key]['size'] }} kB)</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <a href="{{ $test['url'] }}"
